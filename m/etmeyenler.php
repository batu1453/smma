...
<head>
    ...
    <title>Sizi Takip Etmeyenler</title>
...
<body>
    <div class="container mx-auto py-10">
        ...
        <h1 class="text-3xl font-bold text-center text-gray-700 mb-6">Sizi Takip Etmeyen Kullanıcılar</h1>
        <div>
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php if (count($notFollowingBack) > 0): ?>
                        <?php $index = 1; ?>
                        <?php foreach ($notFollowingBack as $user): ?>
                            <tr>
                                <td><?= $index++; ?></td>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="3">Tüm kullanıcılar sizi takip ediyor.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
